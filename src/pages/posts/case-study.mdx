...
* Easy access to recall past brews, perhaps this can even be in a graph form showing a variable so the user can learn trends and pick out brews based on a specific target they looking for. This should also be easily determineable by brewing type \(espresso, pour over, etc\)
